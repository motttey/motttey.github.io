  ...
  export default {
    data: () => ({
      ...
      cards: [
        ...
        { title: 'パラレルソレイユ 9',  year: 2017, src: '/parallel9.jpg',
        ...
        { title: 'モチヅ庫 10th Special Site', src: '/10th.png',
        ...
        { title: 'TBD', src: '/doraemon-namecard.png', url: 'https://www.deviantart.com/motttey', description: 'hogehoge', flex: 6 },
      ],
    }),
    mounted: function(){
